...
Run-Step "CafeF HTML financial statements" "python scripts\cafef_financial_statements_html_parser.py --tickers PNJ,FPT,MWG,VCB,SSI,HPG,TCB,MBB,VIC,VHM --periods 3 --summary"
Run-Step "fundamental real layer" "python scripts\fundamental_real_layer.py --tickers PNJ,FPT,MWG,VCB,SSI,HPG,TCB,MBB,VIC,VHM"
...
Run-Step "daily job watcher" "python scripts\daily_job_watcher.py"
