...
Run-Step "CafeF HTML financial statements" "python scripts\cafef_financial_statements_html_parser.py --tickers PNJ,FPT,MWG,VCB,SSI,HPG,TCB,MBB,VIC,VHM --periods 1"
